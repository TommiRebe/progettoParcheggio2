...
namespace Gestione_Posti_Auto_Scuola_2
{
    ...
    public partial class frmLibera : Form
    {
        ...
        private void frmLibera_Load(object sender, EventArgs e)
        {
            ...
            imgLibera.Image = Image.FromFile("C:\\Prova\\progettoParcheggio2\\Gestione Posti Auto Scuola 2\\Image\\fotoparcheggio.png");
            imgLibera.SizeMode = PictureBoxSizeMode.Zoom;
